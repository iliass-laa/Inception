...
if [ ! -f /var/www/html/wp-config.php ]; then
    ...
    sed -i "/DB_COLLATE/a define('WP_REDIS_HOST', 'redis');" /var/www/html/wp-config.php   
    sed -i "/WP_REDIS_HOST/a define('WP_REDIS_PORT', 6379);" /var/www/html/wp-config.php   
    sed -i "/WP_REDIS_PORT/a define('WP_CACHE', true);" /var/www/html/wp-config.php   
fi
